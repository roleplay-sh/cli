...
`,
  ...
  it('defaults real custom scenario targets to LLM provider mode', async () => {
...
`,
    ...
    await expect(runScenario({ scenarioRef: scenarioPath, outDir: join(root, 'runs') })).rejects.toMatchObject({
